...
def paramparser():
    ...
    paramlist = []
    if args.maxEE:
        paramlist.append(['usearch_max_EE', False, args.maxEE])
    if args.minOverlap:
        paramlist.append(['flash_min_overlap', '-m', args.minOverlap])
    if args.minLen:
        paramlist.append(['cutadapt_minlen', '-m', args.minLen])
...
def main():
    ...
    subprocess.call(["snakemake", "--cores", "4"])
